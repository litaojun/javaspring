...
public class EncryptUtilDev {
	 ...
	 * @return
	 */
	public static String genSign(Map<String, Object> beanMap, String apiKey) {
		//SortedMap<String,String> a;
		SortedMap<String, Object> sortedMap = new TreeMap<String, Object>();
		sortedMap.putAll(beanMap);
		...
		toSign.append("key").append("=").append(apiKey);
		System.out.println(toSign);
		return DigestUtils.sha256Hex(toSign.toString()).toUpperCase();
	}
